...
O aplicativo ONG Félix Vidas não compartilha informações pessoais com terceiros, exceto quando expressamente autorizado pelo usuário para fins específicos, como o agendamento de consultas médicas via chamada de vídeo.
...
Tomamos medidas razoáveis para proteger as informações pessoais dos usuários do aplicativo ONG Félix Vidas contra acesso não autorizado, uso indevido ou divulgação.
...
Se você tiver dúvidas ou preocupações sobre esta Política de Privacidade, o uso de sua câmera, arquivos do dispositivo ou microfone no aplicativo ONG Félix Vidas, ou qualquer outro aspecto do aplicativo, entre em contato conosco através dos meios de contato fornecidos no aplicativo.

---

# Privacy Policy - ONG Félix Vidas

**Last Updated: 09/11/2023**

*This Privacy Policy describes how ONG Félix Vidas collects, uses, and shares personal information from users of this application. By using the ONG Félix Vidas app, you agree to the practices described in this policy.*

## Information Collected

### 1. Internet Browsing History

The ONG Félix Vidas app collects information related to internet browsing history solely for the purpose of directing users to three external links: scheduling medical appointments, viewing bus schedules, searching, and enrolling in professional courses, as well as to enhance the user experience.

### 2. Access to Camera, Device Files, and Microphone

The ONG Félix Vidas app may request access to the camera, device files, and microphone to enhance the user experience. These features may be used, for example, to allow the submission of documents related to professional course enrollment or to schedule medical appointments via video call.
...
The ONG Félix Vidas app does not share personal information with third parties, except when expressly authorized by the user for specific purposes, such as scheduling medical appointments via video call.
...
We take reasonable measures to protect the personal information of ONG Félix Vidas app users against unauthorized access, misuse, or disclosure.
...
If you have any questions or concerns about this Privacy Policy, the use of your camera, device files, or microphone in the ONG Félix Vidas app, or any other aspect of the application, please contact us through the contact information provided in the app.
